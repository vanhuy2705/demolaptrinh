...
/// <summary>Lịch đặt sân toàn hệ thống: lọc theo ngày/sân/trạng thái, cảnh báo xung đột.</summary>
public partial class frmLichDatSanAdmin : BaseForm
{
    private List<DatSan> _danhSach = new();

    public frmLichDatSanAdmin()
    {
        InitializeComponent();
    }
